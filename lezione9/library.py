...
print("Expected output: Book is already borrowed")
try:
...
print("Expected output: Book not borrowed by this member")
try:
...
print("Expected output: Member not found")
