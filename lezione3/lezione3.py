...
"""
pizzas = ["margherita", "diavola", "fiori di zucca"]
for pizza in pizzas:
    print(pizza)
for pizza in pizzas:
    print(f"quanto amo pizza {pizza}, troppo bona")
print("viva la pizza")
"""
...
"""
animals = ["leoni", "lupo", "elefante"]
for animal in animals:
    print(animal)
for animal in animals:
    print(f"troppo belli i {animal}, assurdi")
print("magari fossero dei pet")
"""
...
"""
cubes10 = [n**3 for n in range(1,11)]
"""
...
"""
cubes10 = [n**3 for n in range(1,11)]
print("The first three items in the list are: ",cubes10[:3])
lenght = len(cubes10)
print("Three items from the middle of the list are: ",cubes10[lenght//2-2:lenght//2+1])
print("The last three items in the list are: ",cubes10[-3:])
"""
...
• Prove that you have two separate lists. Print the message My favorite pizzas are:, 
    ...
    Print the message My friend’s favorite pizzas are:, and then use a for loop to print 
...
pizzas.append("salmone")
friend_pizzas.append("alici")
print("My favorite pizzas are: ")
printList(pizzas)
print("My friend's favorite pizzas are: ")
printList(friend_pizzas)
"""
...
#   ok
"""
4-15. Code Review: Choose three of the programs you’ve written in this chapter and modify 
...
"""
pizza = "margherita"
print("is a margherita pizza?")
print(pizza == "margherita")
pizza = "margherita"
print("is a diavola pizza?")
print(pizza == "diavola")
"""
...
pizza = "Margherita"
print("is a margherita pizza?")
print(pizza.lower() == "margherita".lower())
print("is a margherita or a diavola pizza?")
print(pizza.lower() == "margherita".lower() or pizza.lower() == "divola".lower())
print("is a margherita and not a diavola pizza?")
print(pizza.lower() == "margherita".lower() and pizza.lower() != "divola".lower())
print("is in my favorite pizzas?")
print(pizza in pizzas)
print("not in in my favorite pizzas?")
...
"""
favorite_fruit = ["mela", "mandarino", "fico"]
if "mela" in favorite_fruit:
    print("A te piacciono veramente le mele!")
if "banana" in favorite_fruit:
    print("A te piacciono veramente le banane!")
if "fico" in favorite_fruit:
    print("A te piacciono veramente i fichi!")
if "mandarino" in favorite_fruit:
    print("A te piacciono veramente i mandarini!")
if "pera" in favorite_fruit:
    print("A te piacciono veramente le pere!")
"""
...
"""
usernames = ["john", "luca", "luigi", "pino", "admin"]
...
• Make sure your comparison is case insensitive. If 'John' has been used, 
    'JOHN' should not be accepted. (To do this, you’ll need to make 
    a copy of current_users containing the lowercase versions of all existing users.)
"""
current_user = ["john", "luca", "luigi", "pino", "admin"]
new_user = ["JOHN", "luke", "gigi", "Pino"]
lower_cu = [name.lower() for name in current_user]
for name in new_user:
    if name.lower() in lower_cu:
        print(f"{name} not available, enter new username")
    else:
